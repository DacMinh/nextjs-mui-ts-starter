        ...
        <div>
            <div>
                ...
                <LinearWithValueLabel
                    trackUpload={trackUpload}   setValue={setValue} />
            ...
            <Grid container spacing={2} mt={5}>
                ...
                >
                    <div style={{ height: 250, width: 250, background: "#ccc" }}>
                        <div>
                            {
                                info.imgUrl &&
                                <img height={250} width={250} src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/images/${info.imgUrl}`} />
                            }
                        </div>
                ...
                <Grid item xs={6} md={8}>
                    ...
                    <TextField
                        value={info?.description} onChange={(e) => setInfo({
                            ...info, description: e.target.value

                        })}

                        id="standard-basic" label="Description" variant="standard" fullWidth margin="dense" />
                    <TextField
                    ...
                    <Button
                        variant="outlined"
                        sx={{ mt: 5 }} onClick={() => handleSubmitForm()}>Save</Button>
                </Grid>
            </Grid>
        </div >
    )
